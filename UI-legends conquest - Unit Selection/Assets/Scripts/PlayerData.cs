...
public static class PlayerData
{
    ...
    //sets the victory message to display after the game is done
    public static void setVicoryMessage(string victory) {
        victoryMessage = victory + " !!";
    }

    //sets the global variables for the game to generate the amount of units and players
